...
Mode: Campaign Required Bosses Only v0.5 - Predefined
Targets: 40

Files:
- Path of Exile 2 - BossRush - Campaign Required Bosses Only v0.5 - Predefined.lss
- PathOfExile2_BossRush_campaign-required-v0.5-predefined_v0.2.0.asl
