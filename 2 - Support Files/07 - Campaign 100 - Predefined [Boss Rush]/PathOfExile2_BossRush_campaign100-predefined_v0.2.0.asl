...
startup
{
    ...
    vars.modeName = "Campaign 100% - Predefined";
    vars.modeExpectedCount = 67;
    ...
    vars.allowedBosses.Add("beira_of_the_rotten_pack");
    vars.allowedBosses.Add("the_devourer");
    vars.allowedBosses.Add("the_brambleghast");
    vars.allowedBosses.Add("the_rust_king");
    vars.allowedBosses.Add("the_rotten_druid");
    vars.allowedBosses.Add("draven");
    vars.allowedBosses.Add("asinia");
    vars.allowedBosses.Add("lachlann");
    vars.allowedBosses.Add("crowbell");
    vars.allowedBosses.Add("king_in_the_mists");
    vars.allowedBosses.Add("the_executioner");
    vars.allowedBosses.Add("candlemass");
    vars.allowedBosses.Add("count_geonor");
    vars.allowedBosses.Add("rathbreaker");
    vars.allowedBosses.Add("rudja_the_dread_engineer");
    vars.allowedBosses.Add("balbala");
    vars.allowedBosses.Add("jamanra_risen_king");
    vars.allowedBosses.Add("kabala_constrictor_queen");
    ...
    vars.allowedBosses.Add("rootdredge");
    vars.allowedBosses.Add("mighty_silverfist");
    vars.allowedBosses.Add("xyclucian_the_chimera");
    vars.allowedBosses.Add("blackjaw_the_remnant");
    vars.allowedBosses.Add("zicoatl_warden_core");
    vars.allowedBosses.Add("ignagduk");
    vars.allowedBosses.Add("mektul_forgemaster");
    ...
    vars.allowedBosses.Add("captain_hartlin");
    vars.allowedBosses.Add("omniphobia_fear_manifest");
    vars.allowedBosses.Add("great_white_one");
    vars.allowedBosses.Add("diamora_song_of_death");
    vars.allowedBosses.Add("the_prisoner");
    vars.allowedBosses.Add("the_blind_beast");
    vars.allowedBosses.Add("krutog_lord_of_kin");
    vars.allowedBosses.Add("scourge_of_the_sky");
    vars.allowedBosses.Add("yama_the_white");
    ...
    vars.allowedBosses.Add("sigbert_sullied_oath");
    vars.allowedBosses.Add("godwin_shattered_creed");
    vars.allowedBosses.Add("oswin_dread_warden");
    vars.allowedBosses.Add("thane_wulfric");
    vars.allowedBosses.Add("lady_elswyth");
    vars.allowedBosses.Add("akthi_final_sting");
    vars.allowedBosses.Add("anundr_sandworm");
    ...
    vars.allowedBosses.Add("lythara_wayward_spear");
    vars.allowedBosses.Add("abominable_yeti");
