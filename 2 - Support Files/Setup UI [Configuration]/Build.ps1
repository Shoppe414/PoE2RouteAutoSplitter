...
Write-Host "Publishing PoE2 Route AutoSplitter Setup UI..."
...
dotnet publish $project -c Release -r win-x64 --self-contained false -p:PublishSingleFile=true -p:DebugType=None -p:DebugSymbols=false -o $publish
...
Write-Host "User launcher: $userExe"
